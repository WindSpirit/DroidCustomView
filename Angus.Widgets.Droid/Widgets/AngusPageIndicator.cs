...
using Angus.Widgets.Droid.EventHandlers;
using Angus.Widgets.Droid.Interfaces;



namespace Angus.Widgets.Droid.Widgets
{

	public class AngusPageIndicator : HorizontalScrollView, IPageIndicator
	{
		...
		public AngusPageIndicator(Context context) : this(context, null) { }
		...
		public AngusPageIndicator(Context context, IAttributeSet attrs) : base(context, attrs)
		{
		...
		{
			private readonly AngusPageIndicator _indicator;

			public TabView(Context context, AngusPageIndicator indicator)
